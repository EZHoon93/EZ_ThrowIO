    ...
    public class ScreenshotConfigDrawer
    {
        ...
        */
        ...
        public void DrawUsage()
        {
            ...
            if (usage == null)
            {
                usage = AssetUtils.GetOrCreate<PhotoUsageDescription>("Assets/AlmostEngine/UltimateScreenshotCreator/Assets/Editor/PhotoUsageDescription.asset", "iOSPhotoUsageDescription", "Assets/");
            }
            if (usage == null)
                return;
			...
			*/
            ...
            {
                if (GUILayout.Button("iOS Gallery permission"))
                {
            ...
            {
                if (GUILayout.Button("Android storage permission"))
                {
            ...
            {
                if (GUILayout.Button("Android legacy external storage"))
                {
